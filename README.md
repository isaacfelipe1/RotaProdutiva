...
API que conecta **pessoas em busca de qualificação** a **voluntários dispostos a ensinar**, promovendo cursos de geração de renda alinhados ao **ODS 4 (Educação de Qualidade)** e **ODS 10 (Redução das Desigualdades)**. A inscrição em cursos é **pública**: qualquer pessoa pode se inscrever, sem necessidade de cadastro na plataforma. Já os tutores/voluntários que desejam oferecer cursos precisam se cadastrar e passar por um fluxo de aprovação administrativa. Desenvolvida em **.NET 8** seguindo os princípios de **Clean Architecture**.
...
**Solução**: o RotaProdutiva é uma plataforma que conecta pessoas em busca de qualificação a voluntários dispostos a ensinar, permitindo o cadastro de cursos gratuitos de geração de renda. A inscrição nos cursos é **pública e não exige cadastro** — qualquer pessoa interessada pode se inscrever informando apenas nome, e-mail e WhatsApp. Já os voluntários (tutores) que desejam oferecer cursos precisam se cadastrar e passam por um fluxo de aprovação administrativa antes de publicar conteúdo, garantindo qualidade e segurança na plataforma. A solução está alinhada ao **ODS 4 (Educação de Qualidade)** e ao **ODS 10 (Redução das Desigualdades)**.
